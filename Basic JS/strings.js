...
// Funções Exclusivas:
// - string.charAt(Number): Retorna o caractere no índice;
...
// - string.lastIndexOf(str, int): igual ao indexOf, porém a busca é feita de trás para a frente;
// Funções Iguais no Python:
// - string.concat(str): Junta duas ou mais strings à string original;
// - string.slice(start, end): Retorna o texto entre os índices;
// - string.split(str, int):
